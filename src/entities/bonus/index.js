...
export const createBonus = (level, x, y, bonusName) => {
    return { 
        level: level,
        x: x,
        y: y,
        ...
        kill (flame = false) {
            if (flame) {
                this.level.addAnimation(createAnimation(this.level, this.x, this.y, this.rendWidth, this.rendHeight, animations.flame.frames, 0.5));
            }
